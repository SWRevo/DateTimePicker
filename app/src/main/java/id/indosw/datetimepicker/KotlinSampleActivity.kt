...
class KotlinSampleActivity : AppCompatActivity(), OnCrashListener {
    private var doubleText: TextView? = null
    private var singleText: TextView? = null
    private var singleTimeText: TextView? = null
    private var singleDateText: TextView? = null
    private var singleDateLocaleText: TextView? = null
    ...
    private var singleBuilder: Builder? = null
    ...
    private fun initView() {
        ...
        val singleLayout = findViewById<LinearLayout>(R.id.singleLayout)
        val doubleLayout = findViewById<LinearLayout>(R.id.doubleLayout)
        val singleDateLocaleLayout = findViewById<LinearLayout>(R.id.singleDateLocaleLayout)
        singleTimeText!!.setOnClickListener { simpleTimeClicked() }
        singleDateText!!.setOnClickListener { simpleDateClicked() }
        singleLayout.setOnClickListener { simpleClicked() }
        doubleLayout.setOnClickListener { doubleClicked() }
        singleDateLocaleLayout.setOnClickListener { singleDateLocaleClicked() }
    }
    ...
    private fun singleDateLocaleClicked() {
        singleBuilder = Builder(this)
    ...
    companion object {
        private const val TAG = "KotlinSampleActivity"
    }
}